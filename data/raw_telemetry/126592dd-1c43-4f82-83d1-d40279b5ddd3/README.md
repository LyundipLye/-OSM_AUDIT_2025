...
## 1. Request Parameters  
    ...
    Name: ECO_L2T_LSTE.002  

    Date Completed: 2026-06-16T00:43:54.860588  

    ID: 126592dd-1c43-4f82-83d1-d40279b5ddd3  
    ...
    Details:  
        ...
        Layers:  
            ...
            EmisWB (ECO_L2T_LSTE.002)  
            LST (ECO_L2T_LSTE.002)  
            LST_err (ECO_L2T_LSTE.002)  
            QC (ECO_L2T_LSTE.002)  
            cloud (ECO_L2T_LSTE.002)  
            height (ECO_L2T_LSTE.002)  
            water (ECO_L2T_LSTE.002)  
    
        Coordinates:  

            Impact, Treated, 51.410315, -0.469366  
            Control, Control, 51.407395, -0.410459  
...
- Comma-separated values file with data extracted for a specific product
  - ECO-L2T-LSTE-002-ECO-L2T-LSTE-002-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - ECO-L2T-LSTE-002-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - ECO-L2T-LSTE-002-request.json
- xml file
  - ECO-L2T-LSTE-002-ECO-L2T-LSTE-002-metadata.xml  
...
- Hook, S., & Hulley, G. (2022). ECOSTRESS Tiled Land Surface Temperature and Emissivity Instantaneous L2 Global 70 m v002. NASA Land Processes Distributed Active Archive Center. https://doi.org/10.5067/ECOSTRESS/ECO_L2T_LSTE.002. Accessed June 16, 2026.
